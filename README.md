...
flowchart TD
    ...
    subgraph FEATURES["services/feature_engineering.py"]
        C1["~40 engineered features:<br/>rolling rainfall (1–72h) · antecedent<br/>precipitation index · discharge anomaly ·<br/>elevation/slope · impervious % ·<br/>drainage capacity · population density"]
    end
...
| **Deployment** | Railway (`railway.toml`, `nixpacks.toml`, `Procfile`) |
